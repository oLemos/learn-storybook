		...
		<div className="h-screen w-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100">
			...
			<footer className="flex flex-col items-center gap-4 mt-8">
				<Text size="sm" asChild>
					<a href="" className="hover:text-gray-200 text-gray-400 underline">Esqueceu sua senha?</a>
				</Text>
				<Text size="sm" asChild>
					<a href="" className="hover:text-gray-200 text-gray-400 underline">Não possui conta? Crie uma agora!</a>
				</Text>
			</footer>
		</div>
	)
